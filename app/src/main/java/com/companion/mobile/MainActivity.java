...
public class MainActivity extends Activity {
    ...
    static boolean hideIfVisible(){MainActivity activity=visibleActivity.get();if(activity==null||!activity.hasWindowFocus())return false;activity.runOnUiThread(()->activity.moveTaskToBack(true));return true;}
    @Override protected void onResume(){super.onResume();visibleActivity=new WeakReference<>(this);FloatingControlService.restore(this);FloatingLauncherService.restore(this);}
    @Override protected void onPause(){if(visibleActivity.get()==this)visibleActivity.clear();super.onPause();}
