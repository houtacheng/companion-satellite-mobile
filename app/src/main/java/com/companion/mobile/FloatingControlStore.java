...
public final class FloatingControlStore {
    ...
    public static void position(Context c,String id,int x,int y){Item old=get(c,id);if(old!=null)save(c,new Item(old.id,old.name,old.host,x,y,old.opacity));}
